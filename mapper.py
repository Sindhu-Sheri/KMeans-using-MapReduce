...
#This function returns a clusterlabel(list of lists) where each list has newly assigned centroid and data instance i.e., 
#['N', ['T', 6, 11, 6, 8, 5, 6, 11, 5, 6, 11, 9, 4, 3, 12, 2, 4]]
...
def assign_label_cluster(distance, data_point, centroids):
    ...
    return [centroids[minIndex][0], data_point]
